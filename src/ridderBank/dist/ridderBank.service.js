...
var RidderBankService = /** @class */ (function () {
    function RidderBankService(config, passengerNotification, stripe, db) {
        this.config = config;
    ...
    RidderBankService.prototype._createPaymentIntentForAddingBalanceByUserId = function (userId, userName, email, amount) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.db.insert(ridderBank_schema_1.RidderBankTable).values({
                                customerId: customer.id,
                                userId: userId
                            }).returning({
    ...
    RidderBankService.prototype._payToFinishOrderById = function (// transaction on ridderBank or passengerBank, not on the stripe
    id, userId, // decreasing the balance of the ridder, and increasing the balance of the passenger
    userName, amount) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.transaction(function (tx) { return __awaiter(_this, void 0, void 0, function () {
                            var responseOfSelectingRidderBank, newRidderBalance, responseOfDecreasingRidderBank, responseOfDeletingOrder, prevOrderData, type, prevOrderId, responseOfDeletingPurchaseOrder, responseOfDeletingSupplyOrder, responseOfCreatingHistory, responseOfCreatingNotification, responseOfSelectingPassengerBank, newPassengerBalance, responseOfIncreasingPassengerBank;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        responseOfDecreasingRidderBank = _a.sent();
                                    ...
                                    case 9:
                                        ...
                                        return [4 /*yield*/, this.passengerNotification.createPassengerNotificationByUserId(notificationTemplate_1.NotificationTemplateOfCreatingHistory(userName, responseOfDeletingOrder[0].passengerId, responseOfCreatingHistory[0].historId))];
                                    case 10:
                                        ...
                                        return [4 /*yield*/, tx.select({
                                                ...
                                                .where(drizzle_orm_1.eq(passengerBank_schema_1.PassengerBankTable.userId, responseOfDeletingOrder[0].passengerId))];
                                    case 11:
                                    ...
                                    case 12:
                                        responseOfIncreasingPassengerBank = _a.sent();
    ...
    RidderBankService.prototype.getMyBalacne = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.select({
    ...
    RidderBankService.prototype.createPaymentIntentForAddingBalance = function (userId, userName, email, amount) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    RidderBankService.prototype.payToFinishOrderById = function (id, userId, userName, amount) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
