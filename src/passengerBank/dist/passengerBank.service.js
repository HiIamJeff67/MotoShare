...
var PassengerBankService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.transaction(function (tx) { return __awaiter(_this, void 0, void 0, function () {
                            var responseOfDeletingOrder, prevOrderData, type, prevOrderId, responseOfDeletingPurchaseOrder, responseOfDeletingSupplyOrder, responseOfCreatingHistory, responseOfCreatingNotification, responseOfSelectingPassengerBank, newPassengerBalance, responseOfDecreasingPassengerBank, responseOfSelectingRidderBank, newRidderBalance, responseOfIncreasingRidderBank;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, tx["delete"](order_schema_1.OrderTable)
                                            .where(drizzle_orm_1.and(drizzle_orm_1.eq(order_schema_1.OrderTable.id, id), drizzle_orm_1.eq(order_schema_1.OrderTable.passengerStatus, "UNPAID"), drizzle_orm_1.eq(order_schema_1.OrderTable.ridderStatus, "UNPAID")))
                                            .returning({
                                    ...
                                    case 1:
                                        ...
                                        if (!(type === "PurchaseOrder")) return [3 /*break*/, 3];
                                    ...
                                    case 2:
                                        ...
                                        return [3 /*break*/, 6];
                                    case 3:
                                        if (!(type === "SupplyOrder")) return [3 /*break*/, 5];
                                    ...
                                    case 4:
                                        ...
                                        return [3 /*break*/, 6];
                                    case 5: throw exceptions_1.ApiPrevOrderIdFormException;
                                    case 6: return [4 /*yield*/, tx.insert(history_schema_1.HistoryTable).values({
                                    ...
                                    case 9:
                                        ...
                                        newPassengerBalance = responseOfSelectingPassengerBank[0].balance - responseOfDeletingOrder[0].finalPrice;
                                    ...
                                    case 11:
                                        ...
                                        newRidderBalance = responseOfSelectingRidderBank[0].balance + responseOfDeletingOrder[0].finalPrice;
    ...
    PassengerBankService.prototype.payToFinishOrderById = function (id, userId, userName) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._payToFinishOrderById(id, userId, userName)];
            });
        });
    };
