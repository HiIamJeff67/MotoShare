...
var PassengerBankController = /** @class */ (function () {
    ...
    PassengerBankController.prototype.payToFinishOrderById = function (passenger, id, response) {
        return __awaiter(this, void 0, void 0, function () {
            var res, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.passengerBankService.payToFinishOrderById(id, passenger.id, passenger.userName)];
                    case 1:
                        res = _a.sent();
                        if (!res || res.length === 0)
    ...
    __decorate([
        common_1.UseGuards(new guard_1.AnyGuard([guard_1.JwtPassengerGuard])),
