...
var PassengerBankController = /** @class */ (function () {
    ...
    PassengerBankController.prototype.listCostomers = function () {
        return this.passengerBankService.listStripeCostomers();
    };
    PassengerBankController.prototype.getCustomerId = function (passenger, response) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.passengerBankService.getPassengerBankByUserId(passenger.id)];
                    case 1:
                        res = _a.sent();
    ...
    __decorate([
        common_1.Get('/')
    ], PassengerBankController.prototype, "listCostomers");
    __decorate([
        common_1.UseGuards(guard_1.JwtPassengerGuard),
        common_1.Get('/getCustomerId'),
        __param(0, decorator_1.Passenger()),
        __param(1, common_1.Res())
    ], PassengerBankController.prototype, "getCustomerId");
