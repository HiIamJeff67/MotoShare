...
24. **E-C-110** - Failed to find any passengerNotifications
	* status : NotFound 404
	* message : "Failed to find any passengerNotifications"

25. **E-C-111** - Failed to find any ridderNot
	* status : NotFound 404
	* message : "Failed to find any ridderNotifications"

26. **E-C-201** - Failed to sign in
	* status : Forbidden 403
	* message : "Failed to sign in"

27. **E-C-202** - Failed to sign in, user with password not match
	* status : Forbidden 403
	* message : "Failed to sign in, user with password not match"

28. **E-C-203** - Failed to sign up
	* status : Forbidden 403
	* message : "Failed to sign up"

29. **E-C-204** - Duplicate userName or email detected 
...
30. **E-C-205** - Failed to create a purchaseOrder
	* status : Forbidden 403
	* message : "Failed to create a purchaseOrder"

31. **E-C-206** - Failed to create a supplyOrder
	* status : Forbidden 403
	* message : "Failed to create a supplyOrder"

32. **E-C-207** - Failed to create a passengerInvite
	* status : Forbidden 403
	* message : "Failed to create a passengerInvite"

33. **E-C-208** - Failed to create a ridderInvite
	* status : Forbidden 403
	* message : "Failed to create a ridderInvite"

34. **E-C-209** - Failed to create a order
	* status : Forbidden 403
	* message : "Failed to create an order"

35. **E-C-210** - Failed to create a passengerInfo
	* status : Forbidden 403
	* message : "Failed to create a passengerInfo"

36. **E-C-211** - Failed to create a ridderInfo
	* status : Forbidden 403
	* message : "Failed to create a ridderInfo"

37. **E-C-212** - Failed to create a passengerCollection
	* status : Forbidden 403
	* message : "Failed to create a passengerCollection"

38. **E-C-213** - Failed to create a ridderCollection
	* stauts : Forbidden 403
	* message : "Failed to create a ridderCollection"

39. **E-C-214** - Failed to create a history
	* status : Forbidden 403
	* message : "Failed to create a history"

40. **E-C-215** - Failed to create a passengerAuth
	* status : Forbidden 403
	* message : "Failed to create a passengerAuth"

41. **E-C-216** - Failed to create a ridderAuth
	* status : Forbidden 403
	* message : "Failed to create a ridderAuth"

42. **E-C-217** - Failed to create a passengerNotification
	* status : Forbidden 403
	* message : "Failed to create a passengerNotification"

43. **E-C-218** - Failed to create a ridderNotification
	* status : Forbidden 403
	* message : "Failed to create a ridderNotification"

44. **E-C-300** - The userName doesn't change at all
	* status : Conflict 409
	* message : "There's no changes on userName"

45. **E-C-301** - The email doesn't change at all
	* status : Conflict 409
	* message : "There's no changes on email"

46. **E-C-302** - The password doesn't change at all
	* status : Conflict 409
	* message : "There's no changes on password"

47. **E-C-351** - The end time is earlier than the start time
	* status : Conflict 409
	* message : "The end time is earlier than the start time"

48. **E-C-352** - The size of uploaded file too large
	* status : NotAcceptable 406
	* message : "The size of uploaded file should be within {maxSize}{unit}"

49. **E-C-353** - Invalid mime type of uploaded file
	* status : NotAcceptable 406
