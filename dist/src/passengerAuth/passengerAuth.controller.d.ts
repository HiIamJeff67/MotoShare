...
export declare class PassengerAuthController {
    ...
    sendAuthCodeToResetForgottenPassword(sendAuthCodeByEmailDto: SendAuthCodeByEmailDto, response: Response): Promise<void>;
    ...
    validateAuthCodeToResetForgottenPassword(resetPassengerPasswordDto: ResetPassengerPasswordDto, response: Response): Promise<void>;
