...
export declare class RidderInviteController {
    ...
    searchBetterFirstRidderInvitesByInviterId(ridder: RidderType, receiverName: string | undefined, limit: string | undefined, offset: string | undefined, searchPriorities: SearchPriorityType | undefined, response: Response): Promise<void>;
    ...
    searchBetterFirstRidderInvitesByReceiverId(passenger: PassengerType, inviterName: string | undefined, limit: string | undefined, offset: string | undefined, searchPriorities: SearchPriorityType | undefined, response: Response): Promise<void>;
