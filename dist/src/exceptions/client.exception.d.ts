...
export declare const ClientPassengerBankNotFoundException: NotFoundException;
export declare const ClientRidderBankNotFoundException: NotFoundException;
...
export declare const ClientCreatePassengerBankException: ForbiddenException;
export declare const ClientCreateRidderBankException: ForbiddenException;
