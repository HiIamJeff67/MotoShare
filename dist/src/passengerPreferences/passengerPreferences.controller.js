...
let PassengerPreferencesController = class PassengerPreferencesController {
    constructor(passengerPreferencesService) {
        this.passengerPreferencesService = passengerPreferencesService;
    }
    async createMyPreferenceByUserName(passenger, preferenceUserName, response) {
        try {
            if (!preferenceUserName) {
                throw exceptions_1.ApiMissingParameterException;
            }
            const res = await this.passengerPreferencesService.createPassengerPreferenceByPreferenceUserName(passenger.id, preferenceUserName);
            if (!res || res.length === 0)
    ...
    async searchMyPaginationPreferences(passenger, preferenceUserName = undefined, limit = "10", offset = "0", response) {
        try {
            ...
            const res = await this.passengerPreferencesService.searchPaginationPassengerPreferences(passenger.id, preferenceUserName, (0, utils_1.toNumber)(limit, true), (0, utils_1.toNumber)(offset, true));
            if (!res || res.length === 0)
    ...
    async deleteMyPreferenceByUserName(passenger, preferenceUserName, response) {
        try {
            if (!preferenceUserName) {
                throw exceptions_1.ApiMissingParameterException;
            }
            const res = await this.passengerPreferencesService.deletePassengerPreferenceByUserIdAndPreferenceUserId(passenger.id, preferenceUserName);
            if (!res || res.length === 0)
                throw exceptions_1.ClientPassengerPreferenceNotFoundException;
            response.status(enums_1.HttpStatusCode.Ok).send({
                deletedAt: new Date(),
...
], PassengerPreferencesController.prototype, "createMyPreferenceByUserName", null);
__decorate([
    (0, common_1.UseGuards)(guard_1.JwtPassengerGuard),
    ...
    __metadata("design:returntype", Promise)
], PassengerPreferencesController.prototype, "searchMyPaginationPreferences", null);
__decorate([
    (0, common_1.UseGuards)(guard_1.JwtPassengerGuard),
    ...
    __metadata("design:paramtypes", [interfaces_1.PassengerType, String, Object]),
    __metadata("design:returntype", Promise)
], PassengerPreferencesController.prototype, "deleteMyPreferenceByUserName", null);
exports.PassengerPreferencesController = PassengerPreferencesController = __decorate([
    (0, common_1.Controller)('passengerPreferences'),
    __metadata("design:paramtypes", [passengerPreferences_service_1.PassengerPreferencesService])
], PassengerPreferencesController);
//# sourceMappingURL=passengerPreferences.controller.js.map