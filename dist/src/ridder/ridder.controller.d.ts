...
export declare class RidderController {
    ...
    getRidderWithInfoByUserName(phoneNumber: string, response: Response): Promise<void>;
    getRidderWithInfoByPhoneNumber(userName: string, response: Response): Promise<void>;
