...
export declare class RidderController {
    ...
    getRidderWithInfoByPhoneNumber(phoneNumber: string, response: Response): Promise<void>;
    ...
    resetAccessTokenToLogout(ridder: RidderType, response: Response): Promise<void>;
