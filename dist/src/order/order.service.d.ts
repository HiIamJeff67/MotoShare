...
export declare class OrderService {
    ...
    searchPaginationOrderForPassengerById(passengerId: string, ridderName: string | undefined, limit: number, offset: number): Promise<{
        id: string;
        ridderStartAddress: string;
        ridderName: never;
    ...
    searchPaginationOrderForRidderById(ridderId: string, passengerName: string | undefined, limit: number, offset: number): Promise<{
        id: string;
        passengerStartAddress: string;
        passengerEndAddress: string;
        passengerName: never;
