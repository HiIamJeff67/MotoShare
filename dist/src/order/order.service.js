...
let OrderService = class OrderService {
    ...
    async getOrderById(id, userId) {
        return await this.db.select({
            ...
            passengerStartCord: order_schema_1.OrderTable.passengerStartCord,
            passengerEndCord: order_schema_1.OrderTable.passengerEndCord,
            ridderStartCord: order_schema_1.OrderTable.ridderStartCord,
            passengerStartAddress: order_schema_1.OrderTable.passengerStartAddress,
            passengerEndAddress: order_schema_1.OrderTable.passengerEndAddress,
            ...
            .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.eq)(order_schema_1.OrderTable.id, id), (0, drizzle_orm_1.or)((0, drizzle_orm_1.eq)(passenger_schema_1.PassengerTable.id, userId), (0, drizzle_orm_1.eq)(ridder_schema_1.RidderTable.id, userId))))
