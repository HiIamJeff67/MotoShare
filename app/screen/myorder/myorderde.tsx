              ...
              <View style={styles.body}>
                {order ? (
                  <>
                    ...
                    <Text style={styles.title}>{t("my remark")}: {user.role == 1 ? order.passengerDescription : order.ridderDescription}</Text>
                    <Text style={styles.title}>{t("other remark")}: {user.role == 1 ? order.ridderDescription : order.passengerDescription}</Text>
                    <Text style={styles.title}>
                      {t("update time")}:{" "}
